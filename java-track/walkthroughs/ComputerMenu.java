...
public class ComputerMenu {
	...
	//good design to separate the processing of the information from the displaying of the menu and verification of user input
	public void processInput(int selection){
		if(selection == 1){
			...
			c.setProcessor(proc);
			System.out.println("Here is the computer's status after changing its processor speed:");
			...
			c.addMemory(mem);
			System.out.println("Here is what the computer looks like after you added memory:");
			System.out.println(c);
		}
	}
	//to display computers iterate over the object ArrayList and print out every computer it contains
	//uses the size method to get elements
	//to retrieve object, use the get method where i is the index
	...
	private void createComputer(){
		...
		System.out.println("Please enter a size of the computer: ");
		int size = s.nextInt();
		while (size < 1){
			System.out.println("Invalid value. Please enter a positive value: ");
			size = s.nextInt();
